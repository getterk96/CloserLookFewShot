...
class MatchingNet(MetaTemplate):
    ...
    def get_logprobs(self, f, G, G_normalized, Y_S, FCE=None):
        ...
        scores = self.relu(F_normalized.mm(G_normalized.transpose(0,
                                                                  1))) * 100  # The original paper use cosine simlarity, but here we scale it by 100 to strengthen highest probability after softmax
